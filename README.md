...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-21 10:57`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/1db28421-700d-4f46-a10f-2a25064f653e.git
$ cd 1db28421-700d-4f46-a10f-2a25064f653e
```
